...
@returns {Boolean|Object} Either returns a false boolean if no tree is loaded, or an object with the encrypted result at "encrypt" and the number of characters missed at "missed".
*/
function encryptFromString(text){
	...
	var multipleReturns = {"encrypt": result, "missed": missedChars};
...
$("#formEncryptForm").on("submit", function(event){
	...
	$("#missedCharacters").text(encrypted["missed"]);
